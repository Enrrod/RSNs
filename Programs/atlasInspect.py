...
def inspectAtlas(data):
    n_roi = 1215          # número de ROIs que tiene el atlas
    roi_list = []
...
if __name__=="__main__":
    ...
    atlasRoute = '/home/enrique/Proyectos/RSNs/Data/Atlases/DS01216.nii'
    ...
    np.savetxt('/home/enrique/Proyectos/RSNs/Data/Atlases/centroidsDS01216.csv', cent, delimiter=",")
